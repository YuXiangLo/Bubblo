...
public class PlayerMovementJumpDownwardState: IPlayerMovementState
{
    public PlayerControl PlayerControl { get; }
    public PlayerData PlayerData { get; }

    public PlayerMovementJumpDownwardState(PlayerControl playerControl, PlayerData playerData)
    {
